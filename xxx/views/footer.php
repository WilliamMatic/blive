<div class="footer-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-left" id="about">
                <h4 class="mb-4">
                    Explorez le monde en direct ! Découvrez une nouvelle perspective avec notre plateforme de visualisation des directs, offrant un accès instantané à des événements en temps réel, des spectacles captivants et bien plus encore.
                </h4>
            </div>
