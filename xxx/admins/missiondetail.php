                            ...
                            <div class="col-lg-10">
                                <div class="card">
                                    <div class="bg-warning-subtle position-relative">
                                        <div class="card-body p-5">
                                            <div class="text-center">
                                                <h3>Titre mission</h3>
                                                <p class="mb-0 text-muted">Début: 16 Sept, 2022</p>
                                                <p class="mb-0 text-muted">Fin: 16 Sept, 2022</p>
                                                <p class="mb-0 text-muted">Nbrs jours restant: 16 Sept, 2022</p>
                                            </div>
                                        </div>
                                        <div class="shape">
                                            <svg
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="text-end">
                                            <a href="#" class="btn btn-danger">Interrompre la mission</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
