    ...
    <body>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="card-title mb-0">Les admins</h5>
                                        ...
                                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-ordering="false">Numéro telephone</th>
                                            ...
                                            <tbody>
                                                <?php  
                                                    require 'models/call/admin/getList.php';
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="assets/avatar/<?= $res->avatar ?>" target="_blank">
                                                                <?= $res->nom ?>
                                                            </a>
                                                        </td>
                                                        <td><?= $res->telephone ?></td>
                                                        ...
                                                        <td>
                                                            <?php  
                                                                if ($res->email == 'ngutshinsisili@gmail.com') {
                                                                    echo '-';
                                                                }else{
                                                            ?>
                                                                <a href="models/call/admin/delete.php?id=<?= $res->id ?>">
        ...
        <div class="modal fade" id="dépôts" tabindex="-1" aria-labelledby="varyingcontentModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form method="POST" action="models/call/admin/add.php" enctype="multipart/form-data">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="varyingcontentModalLabel">Ajouter un admin</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            
                            <div class="mb-3">
                                <label for="name-name" class="col-form-label">Nom complet:</label>
                                <input type="text" class="form-control" name="name" id="name-name" required />
                            </div>

                            <div class="mb-3">
                                <label for="phone-name" class="col-form-label">Numéro telephone:</label>
                                <input type="text" class="form-control" name="phone" id="phone-name" required />
                            </div>

                            <div class="mb-3">
                                <label for="email-name" class="col-form-label">Adresse email:</label>
                                <input type="email" class="form-control" name="email" id="email-name" required />
                            </div>

                            <div class="mb-3">
                                <label for="avatar-name" class="col-form-label">Avatar:</label>
