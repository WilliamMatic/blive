...
>
    <head>
        <meta charset="utf-8" />
        <title>Astuces les plus commentées</title>
    ...
    <body>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Les astuces en vedette <code> du <?= $_SESSION['datedeb'] ?></code><code> au <?= $_SESSION['datefin'] ?></code></code> </h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-ordering="false">Date publication</th>
                                                    <th data-ordering="false">Nbrs commentaires</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>CDD</td>
                                                    <td>
                                                        <a href="../astuce?title-astuces" target="_blank">
        ...
        <div class="modal fade" id="dépôts" tabindex="-1" aria-labelledby="varyingcontentModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form method="POST" action="models/new-admin.php">
                    <div class="modal-content">
                        <div class="modal-header">
