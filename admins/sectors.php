                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%;">
                                            ...
                                            <tbody>
                                                <?php  
                                                    require 'models/call/secteur/getList.php';
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="models/call/secteur/delete.php?id=<?= $res->id ?>">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" name="icon" value="xxx" id="icon-name" required />
