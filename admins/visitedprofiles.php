...
>
    <head>
        <meta charset="utf-8" />
        <title>Les profils visités</title>
    ...
    <body>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Les profils visités <code> du <?= $_SESSION['datedeb'] ?></code><code> au <?= $_SESSION['datefin'] ?></code></code> </h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-ordering="false">Catégorie</th>
                                                    <th data-ordering="false">Nbrs visites</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>CDD</td>
                                                    <td>
                                                        <a href="../profile?willyam-insisili" target="_blank">
        ...
        <div class="modal fade" id="dépôts" tabindex="-1" aria-labelledby="varyingcontentModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form method="POST" action="models/new-sector.php">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" name="icon" id="icon-name" required />
                            </div>

                            <div class="mb-3">
                                <label for="sector-name" class="col-form-label">Nom:</label>
                                <input type="text" class="form-control" name="sector" id="sector-name" required />
                            </div>
