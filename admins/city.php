    ...
    <body>
            ...
            <div class="main-content">
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php  
                            require 'models/call/ville/getPays.php';
                            if ($paysexist = $getPays->fetch(PDO::FETCH_OBJ)) {
                        ?>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="card-title mb-0">Les villes du pays <code style="margin-left: 5px;"><?= $paysexist->designation ?></code></h5>
                                        ...
                                        <div class="card-body">
                                            <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    <?php  
                                                        require 'models/call/ville/getList.php';
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="models/call/ville/delete.php?id=<?= $res->id ?>&amp;pays=<?= $_GET['id'] ?>">
        ...
        <div class="modal fade" id="dépôts" tabindex="-1" aria-labelledby="varyingcontentModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form method="POST" action="models/call/ville/add.php">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="varyingcontentModalLabel">Ajouter une ville</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            
                            <div class="mb-3">
                                <label for="city-name" class="col-form-label">Nom:</label>
                                <input type="hidden" value="<?= $_GET['id'] ?>" name="pays">
                                <input type="text" class="form-control" name="ville" id="city-name" required />
                            </div>
